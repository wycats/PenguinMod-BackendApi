    ...
    app.post(
        ...
        async (req, res) => {
            ...
            if (utils.env.CFCaptchaEnabled !== "false") {
                ...
                const captcha_success = await fetch(
                ...
                console.warn(
                    "resetpassword/sendEmail ran with CFCaptchaEnabled set to false",
                );
            }
            ...
            */
            ...
            const lastEmailSendIP =
                await utils.UserManager.lastEmailSentByIP(userip);
        ...
        <html><body>
        <p style='background-color: #129aeb; color: white; font-size: 48px; font-weight: bold; font-family: "Helvetica Neue", Arial, sans-serif; padding: 60px 10%;' align="center">PatternYard Password Reset</p>
            <h1 style='font-family: "Helvetica Neue", Arial, sans-serif;'>Hello ${username}!</h1>
            <p style='font-family: "Helvetica Neue", Arial, sans-serif;'>You are getting this email as someone has asked to reset the password for this PatternYard account.</p>
        ...
        <img src="https://penguinmod.com/favicon.png" alt="PatternYard" width="64" height="64" style="width: 64px; height: 64px;">
            ...
            const emailPlainText = `PatternYard Password Reset
        ...
        ********************
        ...
        password for this PatternYard account.
